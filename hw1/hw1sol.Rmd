...
cal 2021
```
cal followed by year shows the calendar for that whole year.

```{bash}
cal 9 1752
```
cal month_# year_# displays a calendar for the requested month in the requested year. Strangely, the month of september in 1752 had 11 days missing! This was done during the switch to the Gregorian calendar.
