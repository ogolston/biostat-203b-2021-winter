...
icu_cohort %>%
  ...
  print()
```
The value of 43 seems unrealistic, and I'm also skeptical about the 27.5. These are so much larger than the other values, that it seems unlikely they are legitimate. Even if they are real, they are so rare that it's not really applicable to the wider population. 
