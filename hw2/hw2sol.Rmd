...
I'm also not certain whether you will be able to properly knit/reproduce the file, since I'm relying mostly on a filtered down data set that I saved. As is, it may take some time to run, since it will try to write and read the filtered datasets...  
